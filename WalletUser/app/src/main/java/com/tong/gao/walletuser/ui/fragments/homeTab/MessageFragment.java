...
import com.tong.gao.walletuser.ui.fragments.message.FragmentCustomerInform;
import com.tong.gao.walletuser.ui.fragments.message.FragmentMyOrderInform;
import com.tong.gao.walletuser.ui.fragments.message.FragmentSystemServiceInform;
...
public class MessageFragment extends Fragment implements View.OnClickListener {
    ...
    private FragmentCustomerInform fragmentCustomerInform = null;
    private FragmentSystemServiceInform fragmentSystemServiceInform = null;
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.fl_back:                          //返回
                ...
                fragmentCustomerInform = null;
                fragmentSystemServiceInform = null;
            ...
            case R.id.rl_connect_customer_service:      //联系客服
                ...
                if(null == fragmentCustomerInform){
                    fragmentCustomerInform = new FragmentCustomerInform();
                }

                rlConnectCustomerService.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
                    @Override
                    public void onGlobalLayout() {
                        fragmentCustomerInform.loadData();
                        rlConnectCustomerService.getViewTreeObserver().removeOnGlobalLayoutListener(this);
                    }
                });

                changeFragment(fragmentCustomerInform, true, R.id.rl_connect_customer_service);

                break;

            case R.id.rl_system_inform:                 //系统通知

                if(null == fragmentSystemServiceInform){
                    fragmentSystemServiceInform = new FragmentSystemServiceInform();
                }

                rlSystemInform.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
                    @Override
                    public void onGlobalLayout() {
                        fragmentSystemServiceInform.loadData();
                        rlSystemInform.getViewTreeObserver().removeOnGlobalLayoutListener(this);
                    }
                });

                changeFragment(fragmentSystemServiceInform, true, R.id.rl_system_inform);
